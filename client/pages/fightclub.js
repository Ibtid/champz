...
const fightclub = () => {
  return (
    <div className='h-screen w-screen overflow-hidden bg-white flex items-center justify-center relative'>
      ...
      <div className='absolute top-[45vh] flex flex-wrap items-center justify-center'>
        <div className='flex items-center justify-center'>
          <div className='font-Orbitron text-6xl text-gray mr-5'>1</div>
          <div className='w-[10rem] text-xs font-Roboto text-black'>
            We are all ChampionZ in life
          </div>
        </div>
        <div className='flex items-center justify-center mr-3 ml-3 mt-5 mb-5'>
          <div className='font-Orbitron text-6xl text-gray mr-5'>2</div>
          <div className='w-[10rem]  text-xs font-Roboto text-black'>
        ...
        <div className='flex items-center justify-center m-3'>
          <div className='font-Orbitron text-6xl text-gray mr-5'>3</div>
          <div className='w-[10rem]  text-xs font-Roboto text-black'>
