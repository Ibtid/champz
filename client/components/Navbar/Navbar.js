...
const Navbar = () => {
  return (
    <div className='bg-[rgba(245,245,245,0.8)] backdrop-blur-3xl w-screen h-[5rem] md:h-[7rem] 2xl:h-[8.5rem] z-20 flex items-center justify-between fixed top-0 left-0'>
