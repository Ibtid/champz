...
const gallery = () => {
  ...
  return (
    <div className='min-w-screen min-h-screen bg-white ]'>
      ...
      {/*====================================================== Gallery and buttons ========================================================*/}
      <div className='bg-white h-[7rem] ml-[3vw] flex mr-[3.5vw] items-center justify-between pb-2 md:pb-4  border-b-[1px] border-gray sticky top-16 md:top-20 z-10'>
      ...
      {/*====================================================== Gallery and buttons ========================================================*/}
      <div className=' mt-24 bg-white w-[94vw] ml-[3.3vw] grid grid-cols-2 md:grid-cols-3 lg:grid-cols-4 xl:grid-cols-5 2xl:grid-cols-6 3xl:grid-cols-7'>
